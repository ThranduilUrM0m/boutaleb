...
export const useExpenseStore = create(persist(
    (set, get) => ({
        ...initialState,
        ...generateStateActions('_expenses', ACTION_TYPES, set, initialState),
        ...generateStateActions('_expense', ACTION_TYPES, set, initialState),
        ...generateStateActions('_expenseToEdit', ACTION_TYPES, set, initialState),
    }),
    {
