...
export const useExpertiseStore = create(persist(
    (set, get) => ({
        ...initialState,
        ...generateStateActions('_expertises', ACTION_TYPES, set, initialState),
        ...generateStateActions('_expertise', ACTION_TYPES, set, initialState),
        ...generateStateActions('_expertiseToEdit', ACTION_TYPES, set, initialState),
    }),
    {
