...
export const usePaymentStore = create(persist(
    (set, get) => ({
        ...initialState,
        ...generateStateActions('_payments', ACTION_TYPES, set, initialState),
        ...generateStateActions('_payment', ACTION_TYPES, set, initialState),
        ...generateStateActions('_paymentToEdit', ACTION_TYPES, set, initialState),
    }),
    {
        name: '_paymentStorage',
