...
export const useArticleStore = create(persist(
    (set, get) => ({
        ...initialState,
        ...generateStateActions('_articles', ACTION_TYPES, set, initialState),
        ...generateStateActions('_article', ACTION_TYPES, set, initialState),
        ...generateStateActions('_articleToEdit', ACTION_TYPES, set, initialState),
    }),
    {
        name: '_articleStorage',
