...
export const useDownvoteStore = create(persist(
    (set, get) => ({
        ...initialState,
        ...generateStateActions('_downvotes', ACTION_TYPES, set, initialState),
        ...generateStateActions('_downvote', ACTION_TYPES, set, initialState),
        ...generateStateActions('_downvoteToEdit', ACTION_TYPES, set, initialState),
    }),
    {
