...
export const useInvestmentStore = create(persist(
    (set, get) => ({
        ...initialState,
        ...generateStateActions('_investments', ACTION_TYPES, set, initialState),
        ...generateStateActions('_investment', ACTION_TYPES, set, initialState),
        ...generateStateActions('_investmentToEdit', ACTION_TYPES, set, initialState),
    }),
    {
        name: '_investmentStorage',
