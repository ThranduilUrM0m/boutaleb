...
export const useSalaryStore = create(persist(
    (set, get) => ({
        ...initialState,
        ...generateStateActions('_salaries', ACTION_TYPES, set, initialState),
        ...generateStateActions('_salary', ACTION_TYPES, set, initialState),
        ...generateStateActions('_salaryToEdit', ACTION_TYPES, set, initialState),
    }),
    {
        name: '_salaryStorage',
