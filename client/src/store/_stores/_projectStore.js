...
export const useProjectStore = create(persist(
    (set, get) => ({
        ...initialState,
        ...generateStateActions('_projects', ACTION_TYPES, set, initialState),
        ...generateStateActions('_project', ACTION_TYPES, set, initialState),
        ...generateStateActions('_projectToEdit', ACTION_TYPES, set, initialState),
    }),
    {
