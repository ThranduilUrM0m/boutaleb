...
export const useSavingStore = create(persist(
    (set, get) => ({
        ...initialState,
        ...generateStateActions('_savings', ACTION_TYPES, set, initialState),
        ...generateStateActions('_saving', ACTION_TYPES, set, initialState),
        ...generateStateActions('_savingToEdit', ACTION_TYPES, set, initialState),
    }),
    {
        name: '_savingStorage',
