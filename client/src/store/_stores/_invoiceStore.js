...
export const useInvoiceStore = create(persist(
    (set, get) => ({
        ...initialState,
        ...generateStateActions('_invoices', ACTION_TYPES, set, initialState),
        ...generateStateActions('_invoice', ACTION_TYPES, set, initialState),
        ...generateStateActions('_invoiceToEdit', ACTION_TYPES, set, initialState),
    }),
    {
        name: '_invoiceStorage',
