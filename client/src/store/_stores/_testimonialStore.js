...
export const useTestimonialStore = create(persist(
    (set, get) => ({
        ...initialState,
        ...generateStateActions('_testimonials', ACTION_TYPES, set, initialState),
        ...generateStateActions('_testimonial', ACTION_TYPES, set, initialState),
        ...generateStateActions('_testimonialToEdit', ACTION_TYPES, set, initialState),
    }),
    {
        name: '_testimonialStorage',
