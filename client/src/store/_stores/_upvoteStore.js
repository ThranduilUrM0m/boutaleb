...
export const useUpvoteStore = create(persist(
    (set, get) => ({
        ...initialState,
        ...generateStateActions('_upvotes', ACTION_TYPES, set, initialState),
        ...generateStateActions('_upvote', ACTION_TYPES, set, initialState),
        ...generateStateActions('_upvoteToEdit', ACTION_TYPES, set, initialState),
    }),
    {
        name: '_upvoteStorage',
