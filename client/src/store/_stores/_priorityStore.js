...
export const usePriorityStore = create(persist(
    (set, get) => ({
        ...initialState,
        ...generateStateActions('_priorities', ACTION_TYPES, set, initialState),
        ...generateStateActions('_priority', ACTION_TYPES, set, initialState),
        ...generateStateActions('_priorityToEdit', ACTION_TYPES, set, initialState),
    }),
    {
        name: '_priorityStorage',
