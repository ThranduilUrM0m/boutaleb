...
export const useDepartmentStore = create(persist(
    (set, get) => ({
        ...initialState,
        ...generateStateActions('_departments', ACTION_TYPES, set, initialState),
        ...generateStateActions('_department', ACTION_TYPES, set, initialState),
        ...generateStateActions('_departmentToEdit', ACTION_TYPES, set, initialState),
    }),
    {
        name: '_departmentStorage',
