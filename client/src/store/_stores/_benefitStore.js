...
export const useBenefitStore = create(persist(
    (set, get) => ({
        ...initialState,
        ...generateStateActions('_benefits', ACTION_TYPES, set, initialState),
        ...generateStateActions('_benefit', ACTION_TYPES, set, initialState),
        ...generateStateActions('_benefitToEdit', ACTION_TYPES, set, initialState),
    }),
    {
        name: '_benefitStorage',
