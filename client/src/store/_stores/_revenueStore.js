...
export const useRevenueStore = create(persist(
    (set, get) => ({
        ...initialState,
        ...generateStateActions('_revenues', ACTION_TYPES, set, initialState),
        ...generateStateActions('_revenue', ACTION_TYPES, set, initialState),
        ...generateStateActions('_revenueToEdit', ACTION_TYPES, set, initialState),
    }),
    {
        name: '_revenueStorage',
