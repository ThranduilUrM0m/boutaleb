...
export const useIncomeStore = create(persist(
    (set, get) => ({
        ...initialState,
        ...generateStateActions('_incomes', ACTION_TYPES, set, initialState),
        ...generateStateActions('_income', ACTION_TYPES, set, initialState),
        ...generateStateActions('_incomeToEdit', ACTION_TYPES, set, initialState),
    }),
    {
        name: '_incomeStorage',
