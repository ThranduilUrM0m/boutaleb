...
const Home = (props) => {
    ...
    const _handleWords = useCallback(async () => {
        setTimeout(() => {
    ...
    const _handleArticleJSONTOHTML = (__articles, __index) => {
        const __article = _.orderBy(
            _.filter(__articles, (_a) => !_a._article_isPrivate),
            ['_article_views'],
            ['desc']
        )[__index];
            ...
            <section className='_s1 grid'>
                ...
                <div className='g-col-7 align-self-end'>
                    <Form className='d-flex flex-column'>
                        ...
                        <div>
                            <p>
                                A Full-Stack Developer & a Graphic Designer
                                <b className='pink_dot'>.</b>
                            </p>
                            <p>
                                Based in{' '}
                                <b className='web'>
                                    Morocco<b className='pink_dot'>.</b>
                                </b>
                            </p>
                        </div>
                        <Button
                ...
                <div className='g-col-5 align-self-center'>
                    <div className='_sliderProjects'>
                        ...
                        <Slider {..._sliderProjectsSettings}>
                            {_.map(
                                _.orderBy(
                                    _.filter(_projects, (_p) => {
                                        return !_p._project_toDisplay;
                                    }),
                                    ['_project_view'],
                                    ['desc']
                                ).slice(0, 10),
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <Card.Body className='no-shadow'>
                                                    <Form className='d-flex flex-column'>
                                                        <span className='text-muted category_author mb-auto'>
                                                        ...
                                                        <span className='text-muted information align-self-end'>
                                                            <b>{_.size(_article._article_views)}</b> Views{' '}
                                                        ...
                                                        <div className='_shadowIndex'>
                                                            <p>
                                                                {_.head(_article._article_title.split(/[\s.]+/))
                                                                    .length <= 2
                                                                    ? _.head(
                                                                        _article._article_title.split(/[\s.]+/)
                                                                    ) +
                                                                    ' ' +
                                                                    _.nth(
                                                                        _article._article_title.split(/[\s.]+/),
                    ...
                    <Card.Body className='grid'>
                        <div className='g-col-4 d-flex flex-column'>
                            <div className='_head d-flex flex-column align-items-center'>
                                ...
                                <h5>
                                    Web Development<b className='pink_dot'>.</b>
                                </h5>
                            </div>
                        ...
                        <div className='g-col-4 d-flex flex-column'>
                            <div className='_head d-flex flex-column align-items-center'>
                                ...
                                <h5>
                                    Graphic Design<b className='pink_dot'>.</b>
                                </h5>
                            </div>
                            <div className='_content d-flex flex-column align-items-center'>
