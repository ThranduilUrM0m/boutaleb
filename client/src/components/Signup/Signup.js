...
const Signup = (props) => {
    ...
    const addUser = user['_user_ADD_STATE'];
    ...
    const [_userPasswordConfirmFocused, setUserPasswordConfirmFocused] =
        useState(false);
    ...
    const onSubmit = async (values) => {
        ...
        try {
            if (values._user_password !== values._user_passwordConfirm)
                throw new Error('Please check your password confirmation');
            return axios
                ...
                .then((response) => {
                    ...
                    setModalBody(
                        'We have sent you a verification email, all you have to do next is just click the link in the email and boom you are one of us now.'
                    );
                                ...
                                <Row className='g-col-12'>
                                    ...
                                    >
                                        <FloatingLabel label='Email.' className='_formLabel'>
                                            ...
                                            {errors._user_email && (
                                                <Form.Text
                                                    className={`bg-danger d-flex align-items-center text-white bg-opacity-75 ${!_.isEmpty(watch('_user_email')) ? '' : 'toClear'
                                                        }`}
                                                >
                                    ...
                                    >
                                        <FloatingLabel label='Username.' className='_formLabel'>
                                            ...
                                            {errors._user_username && (
                                                <Form.Text
                                                    className={`bg-danger d-flex align-items-center text-white bg-opacity-75 ${!_.isEmpty(watch('_user_username')) ? '' : 'toClear'
                                                        }`}
                                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            {errors._user_passwordConfirm && (
                                                <Form.Text
                                                    className={`bg-danger d-flex align-items-center text-white bg-opacity-75 ${!_.isEmpty(watch('_user_passwordConfirm'))
                                                        ? ''
                                                        : 'toClear'
                                                        }`}
                                                >
