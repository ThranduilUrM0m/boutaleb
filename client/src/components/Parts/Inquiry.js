...
const Inquiry = (props) => {
    const _validationSchema = Yup.object()
        .shape({
            ...
            _message: Yup.string().default('').required('Please provide a message.'),
            _newsletter: Yup.boolean().default(false),
        })
        .required();
    const {
        register,
    ...
    const _handleAlphabet = useCallback(async () => {
        let doc = document,
            docElem = doc.documentElement;
        let gridWidth;
        let gridHeight;
        let letterWidth = _.round(
            docElem.clientWidth / _.round(docElem.clientWidth / 30)
        ); // @todo: make this dynamic
        let letterHeight = _.round(
            docElem.clientWidth / _.round(docElem.clientWidth / 30)
        ); // @todo: make this dynamic
        let totalLetters;
        let letterArray = [];
        ...
        try {
            return axios
                ...
                .catch((error) => {
                    ...
                    setModalBody(
                        'Something wrong in your information has blocked this message from being sent'
                    );
                            ...
                            <Col className='g-col-6'>
                                ...
                                >
                                    <FloatingLabel label='Name.' className='_formLabel'>
                                        ...
                                        {errors._name && (
                                            <Form.Text
                                                className={`bg-danger text-danger d-flex align-items-start bg-opacity-25 ${!_.isEmpty(watch('_name')) ? '_fieldNotEmpty' : ''
                                                    }`}
                                            >
                            ...
                            <Col className='g-col-6'>
                                ...
                                >
                                    <FloatingLabel label='Phone.' className='_formLabel'>
                                        ...
                                        {errors._phone && (
                                            <Form.Text
                                                className={`bg-danger text-danger d-flex align-items-start bg-opacity-25 ${!_.isEmpty(watch('_phone')) ? '_fieldNotEmpty' : ''
                                                    }`}
                                            >
                            ...
                            <Col className='g-col-6'>
                                ...
                                >
                                    <FloatingLabel label='Email.' className='_formLabel'>
                                        ...
                                        {errors._emailSender && (
                                            <Form.Text
                                                className={`bg-danger text-danger d-flex align-items-start bg-opacity-25 ${!_.isEmpty(watch('_emailSender'))
                                                    ? '_fieldNotEmpty'
                                                    : ''
                                                    }`}
                                            >
                            ...
                            <Col className='g-col-12'>
                                ...
                                >
                                    <FloatingLabel label='Message.' className='_formLabel'>
                                        ...
                                        {errors._message && (
                                            <Form.Text
                                                className={`bg-danger text-danger d-flex align-items-start bg-opacity-25 ${!_.isEmpty(watch('_message')) ? '_fieldNotEmpty' : ''
                                                    }`}
                                            >
